...
LABEL_RISK = {
    "oral_valid": NO_OBVIOUS_ABNORMALITY,
    "tartar_suspected": ATTENTION_RECOMMENDED,
    "gingiva_redness": VETERINARY_REVIEW_RECOMMENDED,
    "tooth_missing": VETERINARY_REVIEW_RECOMMENDED,
}
